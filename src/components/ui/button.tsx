...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display",
  {
    variants: {
      variant: {
        default: "bg-[#0fbd94] text-white hover:bg-[#0aaa84] shadow-md",
        ...
        // Custom Variants
        cta: "bg-[#0fbd94] text-white hover:bg-[#0aaa84] shadow-md font-bold",
        hero: "bg-[#0fbd94] text-white hover:bg-[#0aaa84] shadow-md font-bold transform hover:scale-105",
        "hero-outline": "border-2 border-white text-white hover:bg-white/10 backdrop-blur-sm",
        nav: "bg-transparent text-foreground hover:text-primary font-medium",
        "nav-cta": "bg-[#0fbd94] text-white hover:bg-[#0aaa84] font-semibold",
      },
      size: {
